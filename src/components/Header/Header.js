...
function Header() {
    ...
    return (
      ...
      //   <div className="header shadow bottom">
      //     <div className="left-logo float-start">
      //       <h2>Full Stack.io</h2>
      //     </div>
      //     <div className="right-div float-end menu-icon">
      //       <button className="btn float-end" data-bs-toggle="offcanvas" data-bs-target="#offcanvas" role="button">
      //         <i className="bi bi-justify fs-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvas"></i>
      //       </button>
      //     </div>
      //     <div className="clear">
...
<h1 className="header-title">Full Stack.io</h1>
 <div className="right-div float-end menu-icon">
  <button className="btn float-end" data-bs-toggle="offcanvas" data-bs-target="#offcanvas" role="button">
  <i className="bi bi-justify fs-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvas"></i>
  </button>
